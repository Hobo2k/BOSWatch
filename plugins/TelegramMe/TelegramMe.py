...
def onLoad():
	...
	configHandler.checkConfig("TelegramMe")
	BOTTokenAPIKey = globalVars.config.get("TelegramMe","BOTTokenAPIKey")
	BOTChatIDAPIKey = globalVars.config.get("TelegramMe","BOTChatIDAPIKey")
	RICforLocationAPIKey = globalVars.config.get("TelegramMe","RICforLocationAPIKey")
	GoogleAPIKey = globalVars.config.get("TelegramMe","GoogleAPIKey")
